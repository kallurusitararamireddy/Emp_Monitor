...
public class UseOfWebsitesPage extends BasePage{

	public UseOfWebsitesPage(WebDriver driver) {
...
//Xls_Reader excel = new Xls_Reader ("‪C:\\Users\\Official\\Downloads\\NaNDetails (19).xlsx");
