...
public class Dashboardpage7_Location_Performance_Checking_page extends BasePage {

	public Dashboardpage7_Location_Performance_Checking_page(WebDriver driver) {
		super(driver);
